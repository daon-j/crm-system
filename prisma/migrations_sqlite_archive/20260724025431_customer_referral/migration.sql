...
INSERT INTO "new_Customer" ("address", "batchId", "birthDate", "createdAt", "email", "grade", "id", "job", "marketingOptIn", "memo", "name", "phone", "updatedAt") SELECT "address", "batchId", "birthDate", "createdAt", "email", "grade", "id", "job", "marketingOptIn", "memo", "name", "phone", "updatedAt" FROM "Customer";
DROP TABLE "Customer";
