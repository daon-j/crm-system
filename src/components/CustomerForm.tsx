  ...
  return (
    <form action={action} className="max-w-xl space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-border px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
          />
          <p className="text-xs text-ink-muted mt-1">민감정보입니다. 화면 노출 시에는 뒷자리가 가려져서 표시됩니다.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          <label className="block text-sm font-medium text-ink-2 mb-1">
            직업 <span className="text-danger">*</span>
          </label>
          <input
            type="text"
            name="job"
      ...
      <div>
        <label className="block text-sm font-medium text-ink-2 mb-1">소개자</label>
        <ReferrerCombobox
        ...
        />
        <p className="text-xs text-ink-muted mt-1">이 고객을 소개해준 기존 고객이 있다면 검색해서 선택하세요. 없으면 비워두세요.</p>
      </div>

      {showContractFields && (
        <div className="rounded-lg border border-border p-4">
          <p className="text-sm font-medium text-ink-2 mb-1">기존 가입 보험상품 (선택)</p>
          <p className="text-xs text-ink-muted mb-3">
          ...
          <div className="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-2">
            <div>
              <label className="block text-sm font-medium text-ink-2 mb-1">보험사</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div>
              <label className="block text-sm font-medium text-ink-2 mb-1">가입일</label>
              <input
                type="date"
            ...
            <div>
              <label className="block text-sm font-medium text-ink-2 mb-1">만기일</label>
              <input
                type="date"
            ...
            <div>
              <label className="block text-sm font-medium text-ink-2 mb-1">월 보험료(원)</label>
              <input
                type="number"
