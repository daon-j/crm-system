              ...
              {images.map((a) => (
                <div key={a.id} className="group relative">
                  ...
                  <form action={deleteNoteAttachment.bind(null, a.id)}>
                    <button
                      type="submit"
                      className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full border border-slate-200 bg-white text-xs text-slate-400 shadow hover:text-red-600 lg:hidden lg:group-hover:flex"
                    >
                      ✕
                    </button>
                  </form>
